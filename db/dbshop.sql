...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2018 at 06:58 AM
...
INSERT INTO `tblusers` (`id`, `email`, `password`, `role`, `fname`, `lname`, `birth`, `phone`, `house_no`, `street`, `barangay`, `city`, `province`, `postal`, `q1`, `q2`, `q1_ans`, `q2_ans`) VALUES
(6, 'admin', '9474421e91bdfef25ccb26e1d464633a', 'admin', '', '', '0000-00-00', '', 0, '', '', '', '', '', '', '', '', '');
